...
# fi
export DPPO_DATA_DIR='/xiaowei/dppo/data'
export DPPO_LOG_DIR='/xiaowei/dppo/log'
export DPPO_WANDB_ENTITY='xiao_wei-westlake-university'
export WANDB_API_KEY='ffa7f46a58ac564642f5dafacb15b7a3509912a9'
export WANDB_API_KEY='P8bM1EZIk47L08JdrPmKX'
export SWANLAB_API_KEY='P8bM1EZIk47L08JdrPmKX'
